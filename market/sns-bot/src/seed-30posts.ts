...
const newPosts = [
  ...
  { category: 'chatgpt_shallow', content: 'Maruzen eBookのURLコピーしてポチレポに貼ったら本1冊が丸ごと資料になった。あとはテーマ入れてポチるだけ。2回無料だよ。\n→ https://pochi-repo.jp\n#電子図書館 #大学生 #レポート #ポチレポ', has_cta: true, weight: 1.2 },
